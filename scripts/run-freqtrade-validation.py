"""CLI wrapper for research-only Freqtrade validation."""
...
from services.research.integrations.freqtrade_adapter import FreqtradeValidationAdapter
...
def main() -> None:
    ...
    result = FreqtradeValidationAdapter().validate(spec, dataset.get("rows", []), run_id=args.run_id)
