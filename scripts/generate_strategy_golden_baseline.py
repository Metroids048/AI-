    ...
    *,
    ...
    manifest = {
        ...
        "active_strategy": {
            ...
            "strategy_code_hash": active_strategy["manifest"]["strategy_code_hash"],
            "strategy_package_hash": active_strategy["manifest"]["strategy_package_hash"],
            "strategy_source_commit": active_strategy["manifest"]["strategy_source_commit"],
            "approval_commit": active_strategy["manifest"].get("approval_commit"),
