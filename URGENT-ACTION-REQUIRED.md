...
> 已过期（2026-07-16）：本文件保留作历史记录。它包含“LLM 故障会强制拒单”和“原始收益率应改按 R 倍数计算”等不符合当前本地代码的结论。请改用 `docs/diagnosis/2026-07-16-automatic-paper-order-remediation.md` 和运行时数据库/调度状态进行判断。
