    ...
    assert body["items"] == [
        {
            ...
            "entry_authority": "TESTNET_CANARY",
            # A candidate key proves strategy evaluation, not that a base signal existed.
            "signal_generated": False,
            "base_signal_detected": False,
            "base_signal_side": None,
            "mtf_alignment_passed": None,
            "confirmation_bars_passed": None,
